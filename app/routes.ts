...
export default [
  layout('features/home/layout/home-layout.tsx', [
    ...
    ...prefix('/engineers', [
      index('features/engineers/pages/engineers-page.tsx'),
      route('/education', 'features/engineers/pages/education-page.tsx'),
    ]),
    ...prefix('/projects', [
      index('features/projects/pages/projects-page.tsx'),
    ]),
